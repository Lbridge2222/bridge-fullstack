...
export default function CommsHub() {
  ...
  return (
    <div className="p-4">
      <div className="mb-6">
        <h1 className="text-2xl font-bold text-foreground mb-2">Communications Hub</h1>
        <p className="text-muted-foreground">Manage email marketing, SMS campaigns, and communication workflows</p>
      </div>
