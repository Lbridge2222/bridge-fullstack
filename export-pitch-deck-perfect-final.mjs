...
const OUTPUT_PDF = 'Ivy-OS-Pitch-Deck-Perfect-Final.pdf';
const VIEWPORT = { width: 1920, height: 1080 };
const RENDER_WAIT_MS = 2000;

(async () => {
  console.log('🚀 Starting perfect final pitch deck export...');
  ...
  try {
    ...
    for (let i = 0; i < slideInfo.totalSlides; i++) {
      ...
      // For slide 1, capture normally without zooming out
      if (i === 0) {
        console.log('📸 Capturing slide 1 normally...');
        ...
        const slideImage = `slide-${String(i + 1).padStart(2, '0')}.png`;
    ...
    console.log('📄 Creating perfect final PDF...');
...
<body>
    ...
    const htmlPath = join(__dirname, 'temp-perfect-final-pdf.html');
    ...
    console.log(`✅ Perfect final PDF exported successfully: ${OUTPUT_PDF}`);
